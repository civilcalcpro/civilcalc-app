...
export default function OneWaySlabCalculatorPage() {
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "What is a one way slab?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "A one way slab is an RCC slab in which load is mainly transferred in one direction. It usually occurs when the longer span divided by the shorter span is greater than or equal to 2.",
        },
      },
      {
        "@type": "Question",
        name: "How do you identify a one way slab?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "A slab is generally considered a one way slab when the longer span to shorter span ratio is greater than or equal to 2. Main reinforcement is provided along the shorter span.",
        },
      },
      {
        "@type": "Question",
        name: "Where is main reinforcement provided in one way slab?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "In a one way slab, main reinforcement is provided along the shorter span because load is mainly transferred in that direction.",
        },
      },
      {
        "@type": "Question",
        name: "Which inputs are required for one way slab design?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Common inputs for one way slab design include shorter span, longer span, slab thickness, concrete grade, steel grade, dead load, live load and clear cover.",
        },
      },
    ],
  };
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <section className="rounded-2xl border border-orange-500/30 bg-orange-500/5 p-8 mb-12">
          ...
          <p className="text-slate-300 leading-8 mb-4">
            A one way slab is a reinforced concrete slab in which the load is
            mainly transferred in one direction. Generally, when the longer span
            divided by the shorter span is greater than or equal to 2, the slab
            behaves as a one way slab. Main reinforcement is provided along the
            shorter span, and distribution reinforcement is provided along the
            longer span.
          </p>

          <div className="rounded-xl border border-slate-800 bg-slate-900/70 p-5 my-6">
            <p className="text-xl font-bold text-white mb-2">
              One Way Slab Condition = Longer Span / Shorter Span &gt;= 2
            </p>
            ...
            <p className="text-slate-400">
              L = effective shorter span, wu = factored load per meter width.
            </p>
          </div>
          ...
          <p className="text-slate-400 leading-7 mt-5">
            Example: If shorter span is 3 m and longer span is 7 m, span ratio
            is 7 / 3 = 2.33. Since the ratio is greater than 2, the slab behaves
            as a one way slab. Main reinforcement is provided along the shorter
            span and distribution reinforcement is provided along the longer
            span.
          </p>
        </section>
        ...
        <section className="mt-16 space-y-8">
          ...
          <div className="bg-slate-900/70 border border-slate-800 rounded-2xl p-6">
            ...
            <p className="text-slate-300 leading-7 mb-4">
              ...
              direction. It is usually supported on two opposite sides and the
              main reinforcement is provided along the shorter span direction.
            </p>

            <p className="text-slate-300 leading-7">
              One way slabs are commonly used in residential buildings,
              corridors, balconies, small rooms, and slab panels where the
              longer span is much greater than the shorter span.
            </p>
          </div>
          ...
          <div className="bg-slate-900/70 border border-slate-800 rounded-2xl p-6">
            ...
            <p className="text-slate-300 leading-7 mt-4">
              Since the span ratio is greater than 2, the slab behaves as a one
              way slab.
            </p>
          </div>
