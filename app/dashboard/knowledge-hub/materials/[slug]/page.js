...
import { materials } from '@/lib/knowledgeHub/materialsData'
  ...
  return (
    <main className="min-h-screen bg-[#050B1F] px-4 py-8 text-white sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl">
        <div className="mb-8 rounded-3xl border border-slate-800 bg-slate-900/70 p-6 sm:p-8">
          <Link
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          ...
          <Section title="IS Code References" icon={BookOpen}>
            ...
            <p className="mt-4 rounded-xl border border-yellow-500/20 bg-yellow-500/10 p-4 text-sm text-yellow-100">
              ...
              For final design, execution and legal approval, always verify the
              latest official BIS standard and project specification.
            </p>
          </Section>
